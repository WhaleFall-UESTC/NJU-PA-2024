...
#define ECALL(dnpc) do { dnpc = (ecall(R(isa_reg_str2val("a7", NULL)), s->pc)); } while(0)
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 11100 11", mret   , N, s->dnpc = GCSR(0));  // 0x341 is mepc
